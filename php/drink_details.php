...
if (isset($_GET['drink_id']) && !empty($_GET['drink_id'])) {
    $drink_id = $_GET['drink_id'];

    $stmt = pdo()->prepare("SELECT * FROM Drinks WHERE drink_id = ?");
    ...
    <div class="container">
        <div class="product_details_wrapper">
            ...
            <div class="product_details-left">
                <img src="<?php echo $drink['image_path']; ?>" alt="<?php echo $drink['name']; ?>">
            </div>

            <div class="product_details-middle">
                <h1 class="product_details-title"><?php echo $drink['name']; ?></h1>
                <p class="product_details-description"><?php echo $drink['description']; ?></p>
                <div class="product_details-middle-bottom">
                    <p class="product_details-cost"><?php echo $drink['price']; ?> ₽</p>
            ...
            <div class="product_details-right">
                ...
                <ul class="product_details-info">
                    <li>
                        <?php echo isset($drink['proteins']) ? $drink['proteins'] : '?'; ?>
                        <span>Белки</span>
                    </li>
                    <li>
                        <?php echo isset($drink['fats']) ? $drink['fats'] : '?'; ?>
                        <span>Жиры</span>
                    </li>
                    <li>
                        <?php echo isset($drink['carbohydrates']) ? $drink['carbohydrates'] : '?'; ?>
                        <span>Углеводы</span>
                    </li>
                    <li>
                        <?php echo isset($drink['calories']) ? $drink['calories'] : '?'; ?>
                        <span>Калории</span>
                    </li>
                </ul>
