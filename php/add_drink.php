...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = pdo()->prepare("INSERT INTO Drinks (name, fats, carbohydrates, calories, proteins, price, image_path, description) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->execute([$name, $fats, $carbohydrates, $calories, $proteins, $price, $target_file, $description]);
...
<body>
    <div class="add-product-form">
        <div class="container">
            <h1 class="title">Добавить напиток</h1>
