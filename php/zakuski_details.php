...
if (isset($_GET['snack_id']) && !empty($_GET['snack_id'])) {
    $snack_id = $_GET['snack_id'];

    $stmt = pdo()->prepare("SELECT * FROM Snacks WHERE snack_id = ?");
    $stmt->execute([$snack_id]);
...
<head>
    ...
    <title>Подробная информация о закуске</title>
    ...
    <div class="container">
        <div class="product_details_wrapper">
            ...
            <div class="product_details-left">
                <img src="<?php echo $snack['image_path']; ?>" alt="<?php echo $snack['name']; ?>">
            </div>

            <div class="product_details-middle">
                <h1 class="product_details-title"><?php echo $snack['name']; ?></h1>
                <p class="product_details-description"><?php echo $snack['description']; ?></p>
                <div class="product_details-middle-bottom">
                    <p class="product_details-cost"><?php echo $snack['price']; ?> ₽</p>
                    <div class="product_details-view">
                        <span><?php echo $snack['quantity']; ?> шт</span>
                    </div>
                </div>
            </div>
            ...
            <div class="product_details-right">
                ...
                <ul class="product_details-info">
                    <li>
                        <?php echo isset($snack['proteins']) ? $snack['proteins'] : '?'; ?>
                        <span>Белки</span>
                    </li>
                    <li>
                        <?php echo isset($snack['fats']) ? $snack['fats'] : '?'; ?>
                        <span>Жиры</span>
                    </li>
                    <li>
                        <?php echo isset($snack['carbohydrates']) ? $snack['carbohydrates'] : '?'; ?>
                        <span>Углеводы</span>
                    </li>
                    <li>
                        <?php echo isset($snack['calories']) ? $snack['calories'] : '?'; ?>
                        <span>Калории</span>
                    </li>
                </ul>
